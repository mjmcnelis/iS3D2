...
cp tests/modified_distribution/central/$1_bulk/input/surface.dat input
cp tests/modified_distribution/central/$1_bulk/parameters/$2/$3/iS3D_parameters.dat .
...
cp results/continuous/dN* tests/modified_distribution/central/$1_bulk/data/$2/$3
